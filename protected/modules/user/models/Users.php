...
class Users extends JLActiveRecord
{
	...
	/**
	 * This method used create public key id
	 * I'm seem id auto icrement
	 **/
	public static function createPublicId(){
		return md5(uniqid(32));
	}
	public static function encodePassword($str=NULL){
		return sha1(md5($str));
	}
	public static function comparePassword($pass=NULL){
		if(sha1(md5($pass))==$this->password) return true;
		else false;
	}
	public static function getInfo($binID=NULL){
	...
	/**
	 * This method used login application
	 **/
