...
<!-- Mirrored from 192.69.216.111/themes/preview/ace/ by HTTrack Website Copier/3.x [XR&CO'2013], Wed, 18 Sep 2013 06:51:02 GMT -->
<head>
		<meta charset="utf-8" />
			...
			<div class="main-container-inner">
				...
				<div class="sidebar" id="sidebar">
					...
					<ul class="nav nav-list">
						...
						<li class="<?php echo (Yii::app()->controller->module->id  == "user" && Yii::app()->controller->id ==  "admin") ? "active" : "";?>">
						...
						<li class="<?php echo (Yii::app()->controller->module->id  == "user" && Yii::app()->controller->id ==  "groups") ? "active" : "";?>">
							...
							<ul class="submenu">
								<li>
									<a href="<?php echo Yii::app()->createUrl("/user/groups");?>">
										<i class="icon-double-angle-right"></i>
										Manage groups
									</a>
								</li>
								...
								<li>
									<a href="<?php echo Yii::app()->createUrl("/user/groups/create");?>">
										<i class="icon-double-angle-right"></i>
										Create group
									</a>
								</li>
...
<!-- Mirrored from 192.69.216.111/themes/preview/ace/ by HTTrack Website Copier/3.x [XR&CO'2013], Wed, 18 Sep 2013 06:51:30 GMT -->
</html>
